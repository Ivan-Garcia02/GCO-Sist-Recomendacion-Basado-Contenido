def print_table(document_number, matrix, matrix_tf, matrix_tf_idf, values_idf, terms, max_string_length):
    ...
    print("\033[1;34m{:<{width}} {:<{width}} {:<{width}} {:<{width}} {:<{width}} {:<{width}} \033[0m".format('Índice', 'Término', 'Nº apariciones', 'TF', 'IDF', 'TF-IDF', width=max_string_length))
    for term_index in range(len(matrix[document_number])):
        if matrix[document_number][term_index] > 0:
            print("{:<{width}} {:<{width}} {:<{width}} {:<{width}} {:<{width}} {:<{width}} ".format(term_index, terms[term_index], int(matrix[document_number][term_index]), matrix_tf[document_number][term_index], values_idf[term_index], matrix_tf_idf[document_number][term_index], width=max_string_length))
    print()
